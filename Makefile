...
BELL_CORE = $(BELL_SRC)/Bell/Core
BELL_EVENTS = $(BELL_SRC)/Bell/Events
BELL_IMGUI = $(BELL_SRC)/Bell/ImGui
BELL_RENDERER = $(BELL_SRC)/Bell/Renderer
BELL_PLATFORM = $(BELL_SRC)/Bell/Platform
BELL_OPENGL = $(BELL_PLATFORM)/OpenGL
...
export CFLAGS LIBS BELL_CORE BELL_RENDERER BELL_EVENTS BELL_IMGUI BELL_PLATFORM BELL_OPENGL  BELL_BIN BELL_LIB EXT_LOG_DIR EXT_GLAD_DIR EXT_GLFW_DIR EXT_DIR EXT_IMGUI_DIR SANDBOX_DIR SANDBOX_BIN 
